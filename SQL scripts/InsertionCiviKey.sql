...
insert into dbo.tContact(Name,Description,LogoPath)values('Invenietis','<p>Invenietis, SSII créée en 2006, est impliquée dans le projet CiviKey depuis son lancement à IN''TECH INFO en Septembre de la même année.</br>L''entreprise porte ce projet bénévolement en réalisant la majorité des développements. Elle suit également des étudiants désirant développer de nouvelles fonctionnalités pour le CiviKey, pour les aider dans leur démarche.</p>','invenietis.png'); --5
insert into dbo.tContact(Name,Description,LogoPath)values('Fondation Steria','<p>La Fondation Steria – Institut de France s’inscrit dans la politique de solidarité du Groupe Steria, qui a pour objectif de favoriser l’autonomie de publics en difficulté en leur donnant accès à l’éducation, à l’informatique et à un métier. La Fondation est née d’une démarche participative de collaborateurs de Steria en France. Elle a pour objectif de contribuer à la réduction de la fracture numérique.</p>','fondation-steria.png'); --6
insert into dbo.tContact(Name,Description,LogoPath)values('Alcatel-Lucent','Société Alcatel-Lucent','alcatel-lucent.png'); --7
insert into dbo.tContact(Name,Description,LogoPath)values('IN''TECH INFO','<p>Différents groupes d''élèves se sont succédés à IN''TECH INFO pour travailler sur le Civikey depuis sa création. L''école a toujours voulu accompagner et faire vivre ce projet à vocation humaine. Il est une magnifique vitrine de leur savoir faire et des compétences mises en oeuvre. Ce travail d''équipe entre différentes entités correspond parfaitement à la pédagogie de projets développée à IN''TECH INFO qui souhaite continuer à collaborer à la réussite de ce projet encore de nombreuses années.</p>','intech-info.png'); --8
insert into dbo.tContact(Name,Description,LogoPath)values('PFNT','La PlateForme des Nouvelles Technologies de l''hôpital de Garches','pfnt.png'); --9
...
insert into dbo.tContact(Name,Description,LogoPath)values('Objectif Aide','L''association Objectf Aide','objectif-aide.png'); --12
insert into dbo.tContact(Name,Description,LogoPath)values('Antoine Raquillet','',''); --13
insert into dbo.tContact(Name,Description,LogoPath)values('Fondation Garches','<p>La Fondation Garches a pris la succession de l’Institut Garches, qui avait vu le jour en 1988 à l’initiative des médecins de l’Hôpital Raymond Poincaré, avec le soutien de quelques entreprises. Créée par l’Institut Garches en 2005, avec le soutien du Ministère en charge de la recherche, et d’emblée reconnue d’utilité publique, la Fondation Garches a été la première fondation de recherche à caractère scientifique dans le domaine du Handicap.</p>','fondation-garches.png'); --14

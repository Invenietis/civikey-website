...
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type, LogoPath) values('Automatic update','1.0.0',100,DATEADD(year,-1,GetDate()),1,'<p>Mise à jour automatique de CiviKey.</p>', 2,'')
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type, LogoPath) values('Noyau','1.0.0',100,DATEADD(year,-1,GetDate()),1,'<p>Le noyau de CiviKey. C''est lui qui assure la modularité de CiviKey en gérant le lancement et l''arret des différentes fonctionnalités. <br/> Utilise le .NET Framework 3.5.</p>', 2,'')
--OK
--2.5.2
--6
...
--9
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type, LogoPath) values('Automatic update','1.0.0',100,DATEADD(year,-1,GetDate()),2,'<p>Mise à jour automatique de CiviKey.</p>', 1,'')
--10

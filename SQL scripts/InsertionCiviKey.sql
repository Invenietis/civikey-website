...
insert into dbo.tTestimony (Author,Title,Content,CreationDate ) values('Professeur Philippe Gajdos <br/> Président de la Fondation Garches', 'Au plus près des besoins de personnes handicapées', '"La Fondation Garches, reconnue d’utilité publique, créée par les médecins de l’hôpital Raymond Poincaré, a pour objectif de concevoir des programmes qui répondent au plus près des besoins des personnes en situation de handicap. <br/>Nous le faisons, depuis l’origine, avec le soutien de nos partenaires, et avons ainsi proposé à Alcatel-Lucent d’être associés au projet CIVIKEY, qui reste un programme exemplaire d’aide technique pour des personnes atteintes de déficiences motrices."', GetDate()); 
...
--Creating features
--2.5.1
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type, LogoPath) values('AutoClick','1.0.0',100,DATEADD(year,-1,GetDate()),1,'<p>Cette fonctionnalité permet de simuler des clics souris, sans avoir a utiliser de contacteur, l''immobilité de la souris pendant un temps configurable lance le clic automatiquement. <br/> Un cartouche permet de selectionner le type de clic que l''on veut effectuer : clic gauche, clic droit, double clic ou encore glisser-déposer.</p>', 2,'autoclick.png')
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type, LogoPath) values('Clavier','1.0.0',100,DATEADD(year,-1,GetDate()),1,'<p>Le clavier de CiviKey, celui-ci affiche un clavier configuré via un fichier xml. En editant ce fichier, on peut ajouter ou modifier des touches, pour leur faire envoyer le texte souhaité. <br/>La couleur des touches est modifiable. <br/> Autre fonctionnalités : <br/> le clavier peut être configuré pour se minimiser au bout d''un temps défini d''inaction, minimisant l''espace pris par le clavier sur l''écran.</p>', 2,'clavier.png')
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type, LogoPath) values('Object Explorer','1.0.0',100,DATEADD(year,-1,GetDate()),1,'<p>Outil de configuration de CiviKey, reservé aux utilisateurs confirmés, il permet de décider du lancement automatique d''une fonctionnalité, et de visualiser l''état du système.</p>', 2,'object-explorer.png')
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type, LogoPath) values('Automatic update','1.0.0',100,DATEADD(year,-1,GetDate()),1,'<p>Mise à jour automatique de CiviKey.</p>', 2,'automatic-update.png')
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type, LogoPath) values('Noyau','1.0.0',100,DATEADD(year,-1,GetDate()),1,'<p>Le noyau de CiviKey. C''est lui qui assure la modularité de CiviKey en gérant le lancement et l''arret des différentes fonctionnalités. <br/> Utilise le .NET Framework 3.5.</p>', 2,'noyau.png')
--OK
--2.5.2
--6
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type, LogoPath) values('AutoClick','1.0.0',100,DATEADD(year,-1,GetDate()),2,'<p>Cette fonctionnalité permet de simuler des clics souris, sans avoir a utiliser de contacteur, l''immobilité de la souris pendant un temps configurable lance le clic automatiquement. <br/> Un cartouche permet de selectionner le type de clic que l''on veut effectuer : clic gauche, clic droit, double clic ou encore glisser-déposer</p>', 1,'autoclick.png')
--7
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type, LogoPath) values('Clavier','1.0.0',100,DATEADD(year,-1,GetDate()),2,'<p>Le clavier de CiviKey, celui-ci affiche un clavier configuré via un fichier xml. En editant ce fichier, on peut ajouter ou modifier des touches, pour leur faire envoyer le texte souhaité. <br/>La couleur des touches est modifiable. <br/> Autre fonctionnalités : <br/> le clavier peut être configuré pour se minimiser au bout d''un temps défini d''inaction, minimisant l''espace pris par le clavier sur l''écran.</p>', 1,'clavier.png')
--8
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type, LogoPath) values('Object Explorer','1.0.0',100,DATEADD(year,-1,GetDate()),2,'<p>Outil de configuration de CiviKey, reservé aux utilisateurs confirmés, il permet de décider du lancement automatique d''une fonctionnalité, et de visualiser l''état du système.</p>', 1,'object-explorer.png')
--9
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type, LogoPath) values('Automatic update','1.0.0',100,DATEADD(year,-1,GetDate()),2,'<p>Mise à jour automatique de CiviKey.</p>', 1,'automatic-update.png')
--10
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type, LogoPath) values('Noyau','1.0.0',100,DATEADD(year,-1,GetDate()),2,'<p>Le noyau de CiviKey. C''est lui qui assure la modularité de CiviKey en gérant le lancement et l''arret des différentes fonctionnalités. <br/> Cette nouvelle version utilise le framework .NET 4.0</p>', 3,'noyau.png')

--2.6
--11
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type, LogoPath) values('AutoClick','1.0.0',100,DATEADD(year,-1,GetDate()),3,'<p>Cette fonctionnalité permet de simuler des clics souris, sans avoir a utiliser de contacteur, l''immobilité de la souris pendant un temps configurable lance le clic automatiquement. <br/> Un cartouche permet de selectionner le type de clic que l''on veut effectuer : clic gauche, clic droit, double clic ou encore glisser-déposer.</p>', 1,'autoclick.png')
--12
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type, LogoPath) values('Clavier','1.0.0',100,DATEADD(year,-1,GetDate()),3,'<p>Le clavier de CiviKey, celui-ci affiche un clavier configuré via un fichier xml. En editant ce fichier, on peut ajouter ou modifier des touches, pour leur faire envoyer le texte souhaité. <br/>La couleur des touches est modifiable. <br/> Autre fonctionnalités : <br/> le clavier peut être configuré pour se minimiser au bout d''un temps défini d''inaction, minimisant l''espace pris par le clavier sur l''écran.</p>', 1,'clavier.png')
--13
...
--14
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type, LogoPath) values('Automatic update','1.0.0',100,DATEADD(year,-1,GetDate()),3,'<p>Mise à jour automatique de CiviKey.</p>', 1,'automatic-update.png')
--15
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type, LogoPath) values('Noyau','1.0.0',100,DATEADD(year,-1,GetDate()),3,'<p>Le noyau de CiviKey. C''est lui qui assure la modularité de CiviKey en gérant le lancement et l''arret des différentes fonctionnalités. <br/> Cette nouvelle version utilise le framework .NET 4.0</p>', 1,'noyau.png')
--16
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type, LogoPath) values('Prédiction','1.0.0',0,DATEADD(year,-1,GetDate()),3,'<p>Cette fonctionnalité affiche les mots les plus probables considérant les touches selectionnées précédemment via le clavier CiviKey. Cette prédiction s''adapte à l''utilisateur, en permettant d''enregistrer d''autres mots. Elle augmente automatiquement la pondération des mots les plus utilisés.</p>', 2,'')
--17
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type, LogoPath) values('Défilement clavier','1.0.0',0,DATEADD(year,-1,GetDate()),3,'<p>Les touches du clavier sont ''allumés'' l''une après l''autre, pour permettre à un utilsiateur équipé d''un simple contacteur d''activer des touches du clavier CiviKey. Permet de défiler sur la panel contenant la prédiction de mots.</p>', 2,'')
--18
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type, LogoPath) values('Défilement souris','1.0.0',0,DATEADD(year,-1,GetDate()),3,'<p>Permet à un utilisateur équipé d''un simple contacteur de déplacer la souris, via un système de défilement sur les différentes zones de l''écran. Peut-être associé à l''auto clic pour lancer différents types de clics.</p>', 2,'')
--19
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type, LogoPath) values('Assistant création','1.0.0',0,DATEADD(year,-1,GetDate()),3,'<p>Permet de créer de nouveaux claviers, en choisissant les touches, leur taille et leur disposition.</p>', 2,'')
--20
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type, LogoPath) values('Assistant 1er démarrage','1.0.0',0,DATEADD(year,-1,GetDate()),3,'<p>Assistant de configuration de CiviKey au premier lancement d''un nouvel utilisateur.<br/>Permet de choisir les fonctionnalités à lancer au démarrage de l''application</p>', 2,'')
--21
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type, LogoPath) values('Aide en ligne','1.0.0',50,DATEADD(year,-1,GetDate()),3,'<p>Intégration de point d''information sur les différentes fonctionnalités, pour expliquer le fonctionnement de chacune.</p>', 2,'')

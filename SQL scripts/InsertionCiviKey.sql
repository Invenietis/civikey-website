...
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type) values('Automatic update','1.0.0',100,DATEADD(year,-1,GetDate()),1,'<p>Mise à jour automatique de CiviKey.</p>', 1)
--OK
...
--6
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type) values('Clavier','1.0.0',50,DATEADD(year,-1,GetDate()),2,'<p>Le clavier de CiviKey, celui-ci affiche un clavier configuré via un fichier xml. En editant ce fichier, on peut ajouter ou modifier des touches, pour leur faire envoyer le texte souhaité. <br/>La couleur des touches est modifiable. <br/> Autre fonctionnalités : <br/> le clavier peut être configuré pour se minimiser au bout d''un temps défini d''inaction, minimisant l''espace pris par le clavier sur l''écran.</p>', 3)
--7
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type) values('Object Explorer','1.0.0',50,DATEADD(year,-1,GetDate()),2,'<p>Outil de configuration de CiviKey, reservé aux utilisateurs confirmés, il permet de décider du lancement automatique d''une fonctionnalité, et de visualiser l''état du système.</p>', 3)
--8
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type) values('Automatic update','1.0.0',50,DATEADD(year,-1,GetDate()),2,'<p>Mise à jour automatique de CiviKey.</p>', 2)

--New features
--9
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type) values('Prédiction','1.0.0',100,DATEADD(year,-1,GetDate()),2,'<p>Cette fonctionnalité affiche les mots les plus probables considérant les touches selectionnées précédemment via le clavier CiviKey. Cette prédiction s''adapte à l''utilisateur, en permettant d''enregistrer d''autres mots. Elle augmente automatiquement la pondération des mots les plus utilisés.</p>', 1)
--10
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type) values('Défilement clavier','1.0.0',50,DATEADD(year,-1,GetDate()),2,'<p>Les touches du clavier sont ''allumés'' l''une après l''autre, pour permettre à un utilsiateur équipé d''un simple contacteur d''activer des touches du clavier CiviKey. Permet de défiler sur la panel contenant la prédiction de mots.</p>', 1)
--11
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type) values('Défilement souris','1.0.0',50,DATEADD(year,-1,GetDate()),2,'<p>Permet à un utilisateur équipé d''un simple contacteur de déplacer la souris, via un système de défilement sur les différentes zones de l''écran. Peut-être associé à l''auto clic pour lancer différents types de clics.</p>', 1)
--12
insert into dbo.tFeature(Title,Version,Progress,CreationDate,IdRoadMap,Description, Type) values('Assistant création','1.0.0',50,DATEADD(year,-1,GetDate()),2,'<p>Permet de créer de nouveaux claviers, en choisissant les touches, leur taille et leur disposition.</p>', 1)
